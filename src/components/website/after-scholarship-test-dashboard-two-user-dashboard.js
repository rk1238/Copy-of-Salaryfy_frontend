...
<Modal
                ...
                <div
                  ...
                  <div className="row basket-row pt-3">
                    <div className="col-lg-8">
                      ...
                      <div className="dashboard_main_flex_container">
                        <h1 className="recommended_jobs_first">Recommended Jobs</h1>
                        <div className="dashboard_second_flex">
                        <input className="enter_keyword_input" type="text" name="" id="" placeholder="Enter keyword"/>
   ...
   <div style={{height:'500px'}} className="fresher_placement_company_inner_map_container">
            {data?.map((item, i) => {
              return (
                <div className="fresher_placement_company_inner_main_container">
                  <div className="fresher_placement_company_flex_container">
                    ...
                    <div className="fresher_placement_company_inner_container_flex ">
                     ...
                     <p style={{color:'grey'}}>Status</p>
                      <p style={{borderColor:'grey',color:'grey'}} className="fresher_placement_company_inner_container_date">
                  ...
                  <div className="fresher_placement_company_inner_container_flex_second_container">
                    ...
                    <div style={{padding:'43px'}}>
                        <h3 className="upcoming_interviews">Upcoming Interviews</h3>
                        <div className="upcoming_interview_outer_container">
                          {
                            interview?.map((item,i)=>{
                              return(
                                <div className="upcoming_interview_inner_container">
                              ...
                              <div>
                                ...
                                <button onClick={handleShow} className="view_more_upcoming">View More </button>
