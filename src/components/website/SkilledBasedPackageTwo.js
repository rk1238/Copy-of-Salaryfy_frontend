              ...
              <div className="increase-chart-graph">
                <div className="col-lg-12">
                  <div className="increase-chart-graph-slider mobile-slide">
                    <h4>Rahul, in order to get 12 LPA you need</h4>
                    <p>Subtext here about skilled based program</p>
                  </div>
                </div>
              </div>
                  ...
                  <div className="skilled-based-packaged-list">
                    <div className="skilled-based-inner-wrapper">
                      ...
                      <ul>
                        ...
                        <li>
                          <p>
                            <b>2. Skills :</b> Python, Analytics, power BI,
                            Tableau, ML, etc
                          </p>
                        </li>
                        <li>
      ...
      <section className="well_place_program">
        <div className="container custom-container">
          <div className="section-heading">
            ...
            <p>
              Subtext here Subtext here Subtext here Subtext here Subtext here
              Subtext here
            </p>
          </div>
              ...
              <div className="skilled-based-packaged-list  program-left-wrapper">
                ...
                <div className="skilled-based-packaged-list program-left-wrapper program-last-wrapper">
                  <h2 className="section-heading greens-heading">
                    <span>3</span> Get placed with an average package of {hike_in_LPA} LPA
                  </h2>
                  <div className="right-block fresher-test">
                    <a href="/BasketPayment" className="theme_btn tertiary">
                      Opt skilled package now <img src={arrow} alt="arrow" />
                      <span></span>
                    </a>
                  </div>
                </div>
...
export default SkilledBasedPackageTwo;
