...
const EligibilityForm1 = () => {
  ...
  return (
    ...
    <div className="container">
      ...
      <div style={{width:'65%',margin:'50px auto',boxShadow:'0px 0px 3px grey',padding:'20px',borderRadius:'10px'}} className="placementContainer row eligiblity-form-filds direct_placement_route_sec">
